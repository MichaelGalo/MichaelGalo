[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&width=435&lines=Data+Engineer;Full+Stack+Engineer;AI+Engineer)](https://git.io/typing-svg)

## I'm Michael, a data engineer with a full-stack software engineering foundation.

I love tinkering to find solutions that blend logic and creativity. Whether it’s designing data pipelines, architecting databases, or building full web apps, I enjoy solving problems that require both structure and imagination.

With a growing toolkit across many programming languages, agentic workflows, cloud services, and modern web frameworks, I'm excited by work that makes data accessible, automates the boring stuff, and delivers meaningful impact. In short, I’m all about building systems that help others do what they do best.
...
![DuckLake](https://img.shields.io/badge/DuckLake-ffcd00?style=for-the-badge&logo=data:image/svg+xml;base64,BASE64_ENCODED_SVG_HERE&logoColor=black)
...
![Dremio](https://img.shields.io/badge/Dremio-1A5276?style=for-the-badge&logo=dremio&logoColor=white)
